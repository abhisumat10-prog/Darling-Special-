...
export default function Navbar() {
  return (
    ...
    >
      ...
      <a href="/sandbox.html?mode=challenge1" className="px-5 py-2 text-xs font-mono font-bold tracking-widest uppercase bg-[#ccff00] text-black hover:bg-white transition-colors duration-300">
        Start Challenge
      </a>
    </motion.nav>
  );
