  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-8 text-xs font-mono tracking-widest uppercase text-neutral-400">
        <a href="#" className="hover:text-white transition-colors duration-300">Practice</a>
        <a href="#" className="hover:text-white transition-colors duration-300">Challenges</a>
        <a href="#" className="hover:text-white transition-colors duration-300">About</a>
      </div>
      
      <button className="px-5 py-2 text-xs font-mono font-bold tracking-widest uppercase bg-[#ccff00] text-black hover:bg-white transition-colors duration-300">
        Get Started
      </button>
    </motion.nav>
  );
